...
if (not reRun_beast_only) or ((not os.path.exists("output/c_beast/sampled"+str(sample_index)+"/beast_output/beast"+str(index)+".log.txt")) or (os.path.getsize("output/c_beast/sampled"+str(sample_index)+"/beast_output/beast"+str(index)+".log.txt")<1000)):
